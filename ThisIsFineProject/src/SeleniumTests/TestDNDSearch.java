...
public class TestDNDSearch {
  ...
  @Test
  public void testDNDSearch() throws Exception {
    ...
    driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='Create Character'])[1]/following::section[1]")).click();
    Thread.sleep(1000);
